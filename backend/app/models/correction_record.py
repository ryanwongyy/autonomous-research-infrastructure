...
class CorrectionRecord(Base):
    ...
    correction_type: Mapped[str] = mapped_column(String(32), nullable=False)  # erratum / retraction / update
    description: Mapped[str] = mapped_column(Text, nullable=False)
    affected_claims_json: Mapped[str | None] = mapped_column(Text)  # JSON array of claim IDs or text
