...
class FailureRecord(Base):
    ...
    failure_type: Mapped[str] = mapped_column(String(32), nullable=False)  # data_error, logic_error, hallucination, causal_overreach, source_drift, design_violation, formatting, other
    severity: Mapped[str] = mapped_column(String(16), nullable=False)  # low, medium, high, critical
    detection_stage: Mapped[str] = mapped_column(String(32), nullable=False)  # l1_structural, l2_provenance, etc.
