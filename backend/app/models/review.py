...
class Review(Base):
    ...
    )  # l1_structural, l2_provenance, l3_method, l4_adversarial, l5_human
    ...
    )  # for family-specific rubric tracking
    review_rubric_version: Mapped[str | None] = mapped_column(
        String(32)
    )  # which version of the rubric was used
    ...
    policy_scores_json: Mapped[str | None] = mapped_column(
        Text
    )  # JSON: {actionability, specificity, evidence_strength, stakeholder_relevance, implementation_feasibility}
