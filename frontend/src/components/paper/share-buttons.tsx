...
export function ShareButtons({ title, paperId }: ShareButtonsProps) {
  ...
  function shareTwitter() {
    const text = encodeURIComponent(`${title} — autonomous AI governance research via ARI`);
  ...
  return (
    <div className="flex items-center gap-1">
      <button
        type="button"
        onClick={copyLink}
        className="inline-flex items-center justify-center gap-1.5 rounded-md border border-border bg-background px-3 py-1.5 text-xs font-medium hover:bg-muted transition-colors focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-primary min-w-[44px] min-h-[44px] sm:min-w-0 sm:min-h-0"
        aria-label="Copy permanent link for citation"
        title="Copy a permanent link to this paper"
      >
      ...
      <button
        ...
        className="inline-flex items-center justify-center rounded-md border border-border bg-background px-2 py-1.5 text-xs hover:bg-muted transition-colors focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-primary min-w-[44px] min-h-[44px] sm:min-w-0 sm:min-h-0"
      ...
      <a
        href={`mailto:?subject=${encodeURIComponent(title)}&body=${encodeURIComponent(`I thought you might find this paper relevant to your work:\n\n"${title}"\nAutonomous Research Infrastructure for AI Governance\n\n${getUrl()}\n\nThe paper includes full provenance, quality metrics, and citation export (BibTeX/APA).`)}`}
        className="inline-flex items-center justify-center rounded-md border border-border bg-background px-2 py-1.5 text-xs hover:bg-muted transition-colors focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-primary min-w-[44px] min-h-[44px] sm:min-w-0 sm:min-h-0"
